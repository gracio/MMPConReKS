function [ax,hlines,figh] = plotyyy(x1,y1,x2,y2,x3,y3,ylabels)
...
colors = [0 102 204;0 153 76;204 0 0]/255;
...
set(hlines{1}(1),'LineWidth',2)
set(hlines{1},'Color',colors(1,:))
set(hlines{1}(2),'linestyle','-.')
set(hlines{2}(1),'LineWidth',2)
set(hlines{2},'Color',colors(2,:))
set(hlines{2}(2),'linestyle','-.')
set(ax(1),'Ycolor',colors(1,:)*0.8)
set(ax(2),'Ycolor',colors(2,:)*0.8)
...
ax(3)=axes('Position',pos3,'box','off',...
   'Color','none','XColor','k','YColor',colors(3,:)*0.8,...   
   'xtick',[],'xlim',limx3,'yaxislocation','right');

hlines{3} = line(x3,y3,'Color',colors(3,:),'Parent',ax(3),'lineWidth',2);
limy3=get(ax(3),'YLim');
